...
return [
    ...
    */
    ...
    'product_stock_alert' => "productos con poco stock. <br/> <small class='text-muted'> Basado en la cantidad de alerta del servicio establecida en la pantalla agregar servicio. Compre este servicio antes de que el stock termine. </small>",
    ...
    'alert_quantity' => "Manténgase alerta cuando el stock del servicio llegue o baje de la cantidad especificada. <br> <br> <small class='text-muted'> Los productos con poco stock se mostrarán en el panel de control - Sección de alerta de stock del servicio. </small>", /* modified */
    ...
    'default_profit_percent' => "Margen de beneficio predeterminado de un servicio. <br> <small class='text-muted'> Se usa para calcular el precio de venta en función del precio de compra ingresado. <br/> Puede modificar este valor para productos individuales al tiempo que agrega </small> ",
