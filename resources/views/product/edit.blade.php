    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::text('weight', $product->weight, ['class' => 'form-control', 'placeholder' => 'Ej: 500g, 1.5 Kg']); !!}
          </div>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-4" id="estimated_weight_div" style="@if(empty($product->enable_estimated_weight)) display: none; @endif">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('estimated_weight', !empty($product->estimated_weight) ? @format_quantity($product->estimated_weight) : null, ['class' => 'form-control input_number', 'data-decimal' => '1', 'placeholder' => 'Ej: 1.800 (en Kg/Gr)']); !!}
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
