			...
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
					<div class="form-group">
						...
						<small class="text-danger @if(empty($customer_due)) hide @endif contact_due_text font-weight-bold" style="display: block; margin-top: 5px; font-size: 12px;"><i class="fas fa-exclamation-circle"></i> <span>{{$customer_due ?? ''}}</span></small>
					</div>
					<small>
						<strong>
				...
				<div class="row">
					<div class="col-md-12 text-center" style="margin-bottom: 15px;">
						<button type="button" class="btn btn-default btn-sm" id="toggle_shipping_box" style="border-radius: 8px; font-weight: 600;">
							<i class="fas fa-truck text-primary"></i> + Dirección de Envío y Flete (Opcional) <i class="fas fa-chevron-down text-muted" style="font-size: 10px;"></i>
						</button>
					</div>
				</div>

				<div id="shipping_box_wrapper" style="display: none;">
					@component('components.widget', ['class' => 'box-solid'])
						<div class="col-md-8">
							<div class="form-group">
...
@section('javascript')
	...
	<script src="{{ asset('js/payment_currency.js?v=' . $asset_v) }}"></script>
