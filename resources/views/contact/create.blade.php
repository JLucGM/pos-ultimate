                ...
                <div class="col-md-12">
                    <div style="background: #F8FAFC; border: 1.5px solid #E2E8F0; border-left: 4px solid #0284C7; border-radius: 10px; padding: 12px 16px; margin-bottom: 15px;">
                        <div class="row" style="display: flex; align-items: center; flex-wrap: wrap;">
                            <div class="col-md-7 col-sm-12">
                                <div class="checkbox" style="margin-top: 5px; margin-bottom: 5px;">
                                    <label style="font-weight: 700; color: #1E293B; font-size: 13px; cursor: pointer;">
                                        {!! Form::checkbox('is_tax_withholding_agent', 1, false, ['id' => 'is_tax_withholding_agent']) !!}
                            ...
                            <div class="col-md-5 col-sm-12" id="withholding_rate_container" style="display: none;">
                                <div class="form-group" style="margin-bottom: 0;">
                                    {!! Form::label('tax_withholding_rate', '% Retención de IVA:') !!}
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                                        {!! Form::select('tax_withholding_rate', ['75' => '75% (General SENIAT)', '100' => '100% (Total / Sin requisitos)', '0' => '0% (Exento)'], '75', ['class' => 'form-control', 'id' => 'tax_withholding_rate', 'style' => 'width:100%;']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
