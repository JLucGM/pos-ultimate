...
$(document).ready(function () {
    ...
    jQuery.extend($.fn.dataTable.defaults, {
        ...
        language: {
            ...
            emptyTable: '<div class="audaz-empty-state"><div class="audaz-empty-icon"><i class="fas fa-folder-open"></i></div><div class="audaz-empty-title">' + (LANG.table_emptyTable || 'No hay datos disponibles') + '</div><div class="audaz-empty-desc">No se encontraron registros registrados en esta sección.</div></div>',
            info: LANG.table_info,
            infoEmpty: LANG.table_infoEmpty,
            loadingRecords: '<i class="fas fa-circle-notch fa-spin tw-text-orange-500"></i> Cargando...',
            processing: 'Cargando información...',
            zeroRecords: '<div class="audaz-empty-state"><div class="audaz-empty-icon"><i class="fas fa-search"></i></div><div class="audaz-empty-title">' + (LANG.table_zeroRecords || 'Sin resultados coincidentes') + '</div><div class="audaz-empty-desc">No encontramos coincidencias para los filtros o término de búsqueda aplicado.</div></div>',
            paginate: {
                first: LANG.first,
                last: LANG.last,
                next: LANG.next,
